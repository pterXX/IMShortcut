...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/pterXX/IMShortcut"
  ...
  s.source       = { :git => "https://github.com/pterXX/IMShortcut.git", :tag => s.version.to_s }
  ...
  s.source_files  = "IMShortcut/IMShortcut/**/*.{h,m,swift}"
